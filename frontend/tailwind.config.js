  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'scan-header-5': ['24px', { letterSpacing: '-0.03em', fontWeight: '500' }],
        'scan-header-6': ['16px', { letterSpacing: '-0.03em', fontWeight: '400' }],
        ...
        'results-header-3': ['24px', { letterSpacing: '-0.03em', fontWeight: '500' }],
